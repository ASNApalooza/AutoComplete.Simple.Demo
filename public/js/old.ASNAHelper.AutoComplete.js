...
ASNAHelper.RegisterAutoComplete = function() {
    function forField(args) {
        ...
        var autocompleteHelper = new ASNAHelper.AutoComplete(args);
...
ASNAHelper.AutoComplete = function(args) {
    this.url = null;
    this.ownerId = null;
...
ASNAHelper.AutoComplete.prototype = {
    source: 
...
ASNAHelper.RegisterAutoComplete = function() {
    function forField(args) {
        ...
        var autocompleteHelper = new ASNAHelper.AutoComplete({onSelect: args.onSelect});
